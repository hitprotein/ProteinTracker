  ...
  return (
    <>
      <section className="bg-pt-black py-16 text-pt-white md:py-20">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-pt-white/70">
            Work out exactly how much protein you need per day, based on
            your weight, age, activity level and goal.
          </p>
        </div>
      </section>
      ...
      <article className="mx-auto mt-16 max-w-3xl px-6 pb-24">
        <h2 className="text-2xl font-bold">What is protein and why does it matter?</h2>
        <p className="mt-3 text-pt-black/80">
          Protein is one of the three macronutrients (alongside carbohydrates
          and fat) and the main building block your body uses to repair and
          build muscle, produce enzymes and hormones, and support your immune
          system. Unlike fat, the body doesn't store much protein for later —
          which is why getting enough of it consistently, day after day,
          matters more than most other nutrients.
        </p>

        <h2 className="mt-10 text-2xl font-bold">How is your protein target calculated?</h2>
        <p className="mt-3 text-pt-black/80">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-pt-black/80">
          <li>
            <strong>Your goal</strong> — building muscle and losing weight
            both raise protein needs above simple weight maintenance.
          </li>
          <li>
            <strong>Your activity level</strong> — regular strength training
            or high-performance training increases the amount your body can
            put to use.
          </li>
          <li>
          ...
          <li>
            <strong>Your height and weight together</strong> — rather than
            weight alone, since two people at the same weight but very
            different heights can have very different amounts of lean mass
            to support.
          </li>
          <li>
            <strong>A goal weight</strong>, if you have one — your target is
            calculated partway toward it, not entirely off your current
            weight or entirely off an aspirational one.
          </li>
        </ul>

        <h2 className="mt-10 text-2xl font-bold">Protein per kg of bodyweight</h2>
        <p className="mt-3 text-pt-black/80">
          As a general guide (before the adjustments above are applied):
        </p>
        <ul className="mt-3 list-disc space-y-2 pl-6 text-pt-black/80">
        ...
        <p className="mt-3 text-sm text-pt-black/50">
          These are starting points, not fixed rules — individual needs vary,
          and the calculator above refines these based on your specific
          details.
        </p>
        ...
        <p className="mt-3 text-pt-black/80">
          ...
          cottage cheese, milk and tofu are all efficient ways to hit a daily
          protein target without excess calories. See our{" "}
        ...
        <p className="mt-3 text-pt-black/80">
          Rather than eating most of your protein in one meal, aim to spread
          it fairly evenly across 3–4 meals. Muscle protein synthesis
          responds better to repeated moderate doses through the day than
          to one very large serving. If you're not sure what that looks
          like in practice, our{" "}
